...
/** brief description: set the first (for pos=1) or the second (for pos=2) four bits of iRegsiter
 *
 * Parameters:  parameter a: is the value assigned to the first nibble in iRegister
 *              parameter b: is the value assigned to the second nibble in iRegister
 *              parameter r: a pointer to the memory location of an iRegister data structure
 *
 * return value: void
 *
 * Pre-condition: 0 <= a <= 15 and 0 <= b <= 15 and iRegister != Null
 *
 * Post-condition: The first four bits (0-3) of iRegister will be eqal to the binary value of a, and the second
 * 4 bits (4-7) of iRegister will be equal to the binary value of b, all other values of iRegister (bits 8-31)
 * will stay the same
 *
...
/** brief description: get the first (for pos=1) or the second (for pos=2) four bits of iRegsiter
 *
